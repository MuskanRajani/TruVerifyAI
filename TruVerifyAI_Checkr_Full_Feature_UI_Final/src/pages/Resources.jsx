...
export default function Resources() {
  ...
  return (
    <div className="space-y-28">
      ...
      <section className="section-container">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12">
          {blogs.map((b, i) => (
            <div
              key={i}
              className="group bg-white rounded-2xl overflow-hidden border shadow hover:shadow-xl transition"
            >
              ...
              <div className="p-6 space-y-3">
                <span className="text-[11px] text-brand-primary font-semibold uppercase">
                  {b.tag}
                </span>
      ...
      {/* ✅ WEBINARS — DARK CONTRAST SECTION */}
      ...
      <section className="bg-brand-primary text-white py-16 text-center">
        <h2 className="text-3xl font-bold">
          Want curated learning for your team?
        </h2>
        ...
        <Link
          to="/contact"
          className="mt-6 inline-block bg-white text-brand-primary px-9 py-3 rounded-full font-semibold"
        >
          Contact us
        </Link>
      </section>
