...
export default function IdentityProduct() {
  const benefits = ['Capture and validate government-issued IDs in a candidate-friendly flow.', 'Support for multiple document types and layouts across markets.', 'Flag potential tampering, mismatched data or duplicate profiles.']
    ...
    <div className="bg-white">
      <section className="section-container py-14 sm:py-16 grid md:grid-cols-2 gap-10 items-center text-sm">
        <div>
          ...
          <h1 className="text-2xl sm:text-3xl font-bold mb-3">Identity Verification</h1>
          <p className="text-slate-600 mb-4">
            Verify that candidates are who they say they are with AI-assisted ID document checks, liveness detection and data validation.
          </p>
        </div>
        <img
          src={"https://picsum.photos/seed/identity-product/960/640"}
      ...
      <section className="bg-brand-primary text-white">
        <div className="section-container py-14 text-center text-sm">
          <h2 className="text-2xl font-semibold mb-2">See Identity Verification in action</h2>
