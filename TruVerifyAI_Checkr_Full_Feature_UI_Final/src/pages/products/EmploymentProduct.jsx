...
export default function EmploymentProduct() {
  const benefits = ['Collect and parse offer letters, experience letters and payslips.', 'Highlight date overlaps, unexplained gaps or role mismatches.', 'Adapt to differences in documentation norms across regions.']
    ...
    <div className="bg-white">
      <section className="section-container py-14 sm:py-16 grid md:grid-cols-2 gap-10 items-center text-sm">
        <div>
          ...
          <h1 className="text-2xl sm:text-3xl font-bold mb-3">Employment Verification</h1>
          <p className="text-slate-600 mb-4">
            Confirm prior roles, tenure and employment type with structured, document-based verification designed for global hiring.
          </p>
        </div>
        <img
          src={"https://picsum.photos/seed/employment-product/960/640"}
      ...
      <section className="bg-brand-primary text-white">
        <div className="section-container py-14 text-center text-sm">
          <h2 className="text-2xl font-semibold mb-2">See Employment Verification in action</h2>
