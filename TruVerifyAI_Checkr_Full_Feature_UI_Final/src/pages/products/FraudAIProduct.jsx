...
export default function FraudAIProduct() {
  const benefits = ['Spot signs of document editing and tampering.', 'Detect suspicious reuse of profiles or identity data.', 'Summarize risk into clear tiers with reason codes.']
    ...
    <div className="bg-white">
      <section className="section-container py-14 sm:py-16 grid md:grid-cols-2 gap-10 items-center text-sm">
        <div>
          ...
          <h1 className="text-2xl sm:text-3xl font-bold mb-3">AI Fraud & Risk Engine</h1>
          <p className="text-slate-600 mb-4">
            Layer pattern-based fraud detection and risk scoring on top of your checks to catch issues that simple rules might miss.
          </p>
        </div>
        <img
          src={"https://picsum.photos/seed/fraudai-product/960/640"}
          alt="AI Fraud & Risk Engine"
      ...
      <section className="bg-brand-primary text-white">
        <div className="section-container py-14 text-center text-sm">
          <h2 className="text-2xl font-semibold mb-2">See AI Fraud & Risk Engine in action</h2>
